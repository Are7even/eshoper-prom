                ...
                <div class="product-details"><!--product-details-->
                    ...
                    <div class="col-sm-7">
                        <div class="product-information"><!--/product-information-->
                            ...
                            <?php if ($product->sale): ?>
                                <?php echo Html::img('@web/images/product-details/sale.jpg', ['class' => 'newarrival']) ?>
                            <?php elseif ($product->new): ?>
                                <?php echo Html::img('@web/images/product-details/new.jpg', ['class' => 'newarrival']) ?>
                            <?php endif; ?>
                            ...
                            <p><b>Brand:
                                    <a href="<?php echo Url::to(['category/view', 'id' => $product->category->id]) ?>"><?php echo $product->category->name; ?></a></b>
                            </p>
                                        ...
                                        <div class="single-products">
                                            <div class="productinfo text-center">
                                                ...
                                                <p class="item_product_text"><a
                                                            href="<?php echo Url::to(['product/view', 'id' => $hit->id]) ?>"><?php echo $hit->name; ?></a>
                                                </p>
